...
$domainName = "backend.arcadia.svc.cluster.local";
?>
		  ...
		  <div class="col-12">
			<div class="form-group">
			  <label for="">To</label><select class="form-control" style="background-color:#293145" id="friend_select">
				...
				<option id="Raghu" value=2>
				  Raghu
				</option>
				<option id="Tony" value=3>
				  Tony
				</option>
				<option id="David" value=4>
				  David
				</option>
				<option id="Paula" value=5>
				  Paula
				</option>
				<option id="John" value=6>
				  John
				</option>
				</select>
			</div>
